...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "EVnl_DdOVMLhddVBL3_gquTNKnUGTH-KIzfxjUI7";
    private static final String SECRETKEY = "fYo_clIfPD4FJNOWV2PYD0WQc-FdnrHmQQPcMZMg";
    private static final String BUCKET = "w826600636";
    public static final String DOMAIN= " http://qink6o2vc.hd-bkt.clouddn.com/";
    ...
    private static UploadManager getUploadManager(){
        //构造一个带指定Zone对象的配置类 TODO 区域选择 华南北东西  Zone(地区下标)
    ...
    private static BucketManager getBucketManager(){
        // 创建授权信息
        Auth auth = Auth.create(ACCESSKEY, SECRETKEY);
        // 创建操作某个仓库的管理器  TODO 区域选择 华南北东西  Zone(地区下标)
